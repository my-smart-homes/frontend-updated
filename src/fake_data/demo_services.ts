...
export const demoServices: HassServices = {
  homeassistant: {
    ...
    stop: { description: "Stop the MSH service.", fields: {} },
    restart: { description: "Restart the MSH service.", fields: {} },
    check_config: {
      description:
        "Check the MSH configuration files for errors. Errors will be displayed in the MSH log.",
      fields: {},
    },
    update_entity: {
